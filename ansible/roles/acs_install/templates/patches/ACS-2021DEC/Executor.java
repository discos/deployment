...
public class Executor {
   ...
   static public boolean remote(boolean nativeSSH, String username, String password, String command, String endMark, NativeCommand.Listener listener, String host) throws Throwable {
   	 return remote(nativeSSH,username,password,command,endMark,listener,host,true);
   }
    ...
    */
   static public boolean remote(boolean nativeSSH, String username, String password, String command, String endMark, NativeCommand.Listener listener, String host, boolean fore) throws Throwable {
   	if (nativeSSH)
   		return remoteNative(username, password, command, endMark, listener, host, fore);
   	else
   ...
   static private boolean remoteNative(String username, final String password, final String command, String endMark, NativeCommand.Listener listener, String host) throws Throwable {
   	 return remoteNative(username,password,command,endMark,listener,host,true);
   }	   
   */
    ...
    */
   static private boolean remoteNative(String username, final String password, final String command, String endMark, NativeCommand.Listener listener, String host, boolean fore) throws Throwable {
