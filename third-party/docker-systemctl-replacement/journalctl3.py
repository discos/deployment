...
# Derived from docker-systemctl-replacement (gdraheim/docker-systemctl-replacement)
# Copyright (C) 2016-2026 Guido U. Draheim
# Licensed under the EUPL-1.2 (see LICENSE.EUPL-1.2.md in this directory)
#
# Modifications (C) 2026 Giuseppe Carboni:
# - Use "systemctl" wrapper name instead of "systemctl3.py"
